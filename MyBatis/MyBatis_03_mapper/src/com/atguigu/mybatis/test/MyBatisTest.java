...
public class MyBatisTest {
	...
	public void testInsert() throws IOException{
		...
		try{
			EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			//测试添加
			Employee employee = new Employee(null, "jerry4",null, "女");
...
//			mapper.deleteEmpById(2);
	...
	public void test07() throws IOException{
		...
		try{
			EmployeeMapper mapper = openSession.getMapper(EmployeeMapper.class);
			Map<Integer, Employee> map = mapper.getEmpByLastNameLikeReturnMap("jerry4");
//			System.out.println(map);
			map = mapper.getEmpReturnMap();
			for (Map.Entry<Integer, Employee> iterable_element : map.entrySet()) {
